...
# The database URL always comes from ACR's typed Settings (env / .env), never
# from a hardcoded value in alembic.ini — this is the one source of truth for
# "where is the local SQLite file."
_settings = get_settings()
_settings.ensure_data_dir()
config.set_main_option("sqlalchemy.url", _settings.database_url)

# ORM models registered on acr.db.base.Base drive autogenerate.
